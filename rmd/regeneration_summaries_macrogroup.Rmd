...
```{r grid, fig.cap = numFig("Summary of status and trends for each metric and Macrogroup combination grouped by regeneration condition adapted from <a href='https://www.fs.fed.us/nrs/pubs/jrnl/2018/nrs_2018_vickers_001.pdf'>Vickers et al. (2018).</a> Regeneration status categories are defined as: "), out.width = "90%"}
