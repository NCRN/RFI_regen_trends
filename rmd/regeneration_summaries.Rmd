...
include_graphics("../results/20220325/results_grid_symbols_Final_20220405.svg")
```

<p class='caption'>
<ul>
<li><b>Imminent Failure:</b> Parks with six or more status metrics that are rated "Critical". Parks that are experiencing severe regeneration failure and are at risk of forest loss. In some cases, for example MORR, forest loss is already underway.</li>
<li><b>Probable Failure:</b> Parks with four to five status metrics that are rated "Critical". Parks are also experiencing regeneration failure as indicated by lacking and/or declining sapling density, although seedlings are more abundant than in the Imminent Failure category.</li>
<li><b>Insecure: </b> Parks with one to three status metrics that are rated "Critical". Parks lack sapling density, but have sufficient and often increasing seedling layers and overall lower deer browse impacts. Significant trends in the Insecure category tend to be due to forest dynamics, like succession, than regeneration failure.</li>
<li><b>Secure: </b> Abbreviated as Sec. Parks with no status metrics rated "Critical". Parks have abundant seedling and sapling layers and show few concerning trends.</li>
</ul>
</p>
<p class='caption'>
Status metrics (row 1) are based on the most recent 4 years of data (2016:2019). Status thresholds were defined as:
<ul class = 'caption'>
<li><b>Sapling Density: </b> Densities &lt; 0.1 stems/sq.m are classified as Critical; densities between 0.1 – 0.16 stems/sq.m are classified as Caution (Niewinski et al. 2006); densities ≥ 0.16 stems/sq.m are classified as Acceptable.</li>
...
include_graphics("../results/Region1_manuscript.jpg")
```
...
include_graphics("../results/20220325/TSS_by_sppgrp/stock_final.svg")
```
...
include_graphics("../results/20220325/TSS_by_sppgrp/Tree_BA_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/Tree_Dens_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/Sap_BA_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/Sap_Dens_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/Seed_Dens_Total.svg")
```
...
include_graphics("../results/20220325/spp_grp_plots/Tree_BA.svg")
```
<br>
...
include_graphics("../results/20220325/spp_grp_plots/Tree_Dens.svg")
```
<br>
...
include_graphics("../results/20220325/spp_grp_plots/Sap_BA.svg")
```
<br>
...
include_graphics("../results/20220325/spp_grp_plots/Sap_Dens.svg")
```
<br>
...
include_graphics("../results/20220325/spp_grp_plots/Seed_Dens.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/tree_10cm_BA_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/tree_20cm_BA_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/tree_30cm_BA_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/tree_10cm_Dens_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/tree_20cm_Dens_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/tree_30cm_Dens_Total.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/Sor_sap.svg")
```
<br>
...
include_graphics("../results/20220325/TSS_by_sppgrp/Sor_seed.svg")
```
<br>
...
include_graphics("../results/20220325/cycle_3_status_plots/Pct_stocked_plots.svg")
```
<br>
...
include_graphics("../results/20220325/cycle_3_status_plots/Cycle_3_stocking_index.svg")
```
<br>
...
include_graphics("../results/20220325/cycle_3_status_plots/Cycle_3_sapling_density_natcan.svg")
```
<br>
...
include_graphics("../results/20220325/cycle_3_status_plots/Cycle_3_seedling_density_natcan.svg")
```
<br>
...
include_graphics("../results/20220325/cycle_3_status_plots/Cycle_3_Sorensen_sapling_vs_canopy.svg")
```
<br>
...
include_graphics("../results/20220325/cycle_3_status_plots/Cycle_3_Sorensen_seedling_vs_canopy.svg")
```
<br>
  ...
  for(p in seq_along(park_list)){
    ...
    park_template <- 
      paste0("##### {{park}}\n\n",
             ...
             "knitr::include_graphics(paste0('../results/20220325/park_plots/total/', 
             ...
             "knitr::include_graphics(paste0('../results/20220325/park_plots/spp_grp/', 
               park, '_spp_grp.svg'))\n\n",
             "```\n\n",
             "</details>\n",
             ...
             "knitr::include_graphics(paste0('../results/20220325/park_plots/indices/', 
             ...
             "knitr::include_graphics(paste0('../results/20220325/park_plots/tree_sizes/', 
