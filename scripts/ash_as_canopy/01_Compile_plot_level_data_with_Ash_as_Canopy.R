...
write.csv(live_tree_dens_spp, paste0(datapath, "Live_tree_density_by_plot_spp_ash_as_can.csv"), row.names = F)
...
write.csv(live_sap_dens_spp, paste0(datapath, "Live_sapling_dens_by_plot_spp_ash_as_can.csv"), row.names = F)
...
write.csv(live_seed_dens_spp, paste0(datapath, "Live_seedling_dens_by_plot_spp_ash_as_can.csv"), row.names = F)
...
write.csv(tree_sap_seed, paste0(datapath, "EFWG_tree_sapling_seedling_BA_dens_20220325_ash_as_can.csv"), row.names = F)
names(tree_sap_seed)
...
write.csv(sim_comb, paste0(datapath, "EFWG_Similarity_by_plot_cycle_20220325_ash_as_can.csv"), row.names = F)
...
tree_spp_list <- read.csv(paste0(datapath, "NPS_tree_species_groups.csv")) 
# Promote Fraxinus to not canopy tree
tree_spp_list$Canopy_Tree[grepl("Fraxinus", tree_spp_list$Species)] <- 1
...
write.csv(stock_final, paste(datapath, "EFWG_stocking_index_20220325_ash_as_can.csv", sep = "/"), row.names = F)


#---- Combine all plot-level datasets ----
tss <- read.csv(paste0(datapath, "EFWG_tree_sapling_seedling_BA_dens_20220325_ash_as_can.csv"))
...
sim <- read.csv(paste0(datapath, "EFWG_Similarity_by_plot_cycle_20220325_ash_as_can.csv"))
stock <- read.csv(paste0(datapath, "EFWG_stocking_index_20220325_ash_as_can.csv")) 
